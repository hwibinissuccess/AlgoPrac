    ...
    public static boolean hasWin(String[] board, char ch){
        ...
        for(int i=0; i<3; i++){
            if(board[i].charAt(0) == ch && board[i].charAt(1)==ch
                    && board[i].charAt(2)==ch) return true;
        }

        for(int i=0; i<3; i++){
            if(board[0].charAt(i) ==ch && board[1].charAt(i)==ch
                    && board[2].charAt(i)==ch) return true;
        }

        if(board[0].charAt(0)==ch && board[1].charAt(1)==ch
